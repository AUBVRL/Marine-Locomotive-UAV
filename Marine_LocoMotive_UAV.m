...
X0_u = X0_b + [3 3]; % make alpha_ref_0 = 45.297 deg
V0_u = [0 0];
...
Theta0 = 0*atan2(V_bar*D_x*cos(alpha_bar_0),V_bar*D_x*sin(alpha_bar_0)+m_u*g*cos(alpha_bar_0));%10*pi/180;
